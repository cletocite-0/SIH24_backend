...
class RouteQuery(BaseModel):
    ...
    # datasource: Literal["rag", "chatbot"] = Field(sss
    #     ...,
...
You are an intelligent query router for GAIL companys AsI assistant. Your task is to analyze user queries and determine whether they should be handled by:
