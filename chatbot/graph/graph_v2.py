...
from tools.tools import gmeet, fetch_from_confluence, fetch_from_gdrive, send_email
...
def graph():
    ...
    workflow.add_conditional_edges(
        ...
        {
            "gmeet": "gmeet",
            "fetch_from_confluence": "fetch_from_confluence",
            "fetch_from_gdrive": "fetch_from_gdrive",
            "send_email": "send_email",
        },
    )

    # workflow.add_edge(tools, "reviewer")
    workflow.add_edge("gmeet", "reviewer")
    workflow.add_edge("fetch_from_confluence", "reviewer")
    workflow.add_edge("fetch_from_gdrive", "reviewer")
    workflow.add_edge("send_email", "reviewer")
    workflow.add_edge("metadata_index", "master_agent")
